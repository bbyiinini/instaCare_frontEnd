                ...
                <Grid fluid className="row">
                        ...
                        <Col className="content-column" xs>
                            <div className="request-card">
                                <div className={classes.paddings1}>
                                    <CardHeader
                                        className=""
                                        avatar={<Avatar aria-label="recipe" className={classes.avLarge}
                                                        src={seniorState.avatar}></Avatar>}
                                        title={
                                ...
                                <div className={classes.paddings1}>
                                    {requestMange.status === 3 || (user.userType === 1 && requestMange.status === 1) ? (
                                        ...
                                        <ThemeProvider theme={theme}>
                                            <Button color="primary" variant="contained" className={classes.bHeight}
                                            ...
                                            {commentCollection.map((comment, index) => {
                                                return (
                                                    <TimelineItem key={index}>
                                                        ...
                                                        <TimelineContent>
                                                            <CardHeader action={''} title={comment.user || 'Null'}
                    ...
                    <Col className="nav-column" xs={12} sm={6}>{user.userType === 1 && requestMange.status === 1 ?
                        <><h1>Too Young too simple</h1>
                            <ThemeProvider theme={theme}>
                                <Button color="primary" variant="contained" className={classes.bHeight}
                                        onClick={() => handleOpen('covid')}>Take the request</Button>
                            </ThemeProvider></> :
                        <> <RequestGoogleMap requestId={requestMange.id}
                                             userType={user.userType}></RequestGoogleMap> {requestMange.status === 1 ?
                            ...
                            <Card className={classes.volunteer}>
                                <CardHeader
                                    avatar={<Avatar aria-label="recipe" className={classes.avLarge}
                                                    src={requestMange.volunteerId ? volunteerState.avatar : ""}></Avatar>}
                                    title={<div className={classes.ftSmall}>
                                        <a>{requestMange.volunteerId !== null ? volunteerState.fullName : "N/A"}</a>
                                        <div><PhoneIcon
                                            style={{color: "#41892c"}}/>{requestMange.volunteerId !== null ? volunteerState.phone : "N/A"}
                                        </div>
                                    </div>}
                                ...
                                if (wrapId === 'end' || wrapId === 'cancel') {
                                    return (
                                        <>
                                            ...
                                            <p>Are you sure to {wrapId} this appointment? you will not be able to undo
                                                this action once it is completed.</p>
                                    ...
                                    return (
                                        <div className={classes.paper} style={{
                                            ...
                                            <div style={{
                                                ...
                                                <h6>Are you currently experiencing any of the following symptoms that
                                                    started within the last 14 days?</h6>
                                                <ul>
                                                ...
                                                <h6>Over the past 14 days, have you been informed by a public health
                                                    agency or a healthcare system that you have been exposed to
                                                    COVID-19?</h6>
                                                <br></br>
                                                <h6>Over the past 14 days, has a person in your household been diagnosed
                                                    with COVID-19 infection?</h6>
                                                <br></br>
                                                <h4>If your answer is YES for any of the questions above, we advice you
                                                    to stay home and avoid physical contacts.</h4>
                                                {/* <TextField
